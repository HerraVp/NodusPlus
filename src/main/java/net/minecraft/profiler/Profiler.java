...
public class Profiler
{
    ...
    public List getProfilingData(String p_76321_1_)
    {
        ...
        else
        {
            ...
            if ((float)var8 > var20)
            {
                var7.add(new Result("unspecified", (double)((float)var8 - var20) * 100.0D / (double)var8, (double)((float)var8 - var20) * 100.0D / (double)var3));
            }

            Collections.sort(var7);
            var7.add(0, new Result(p_76321_1_, 100.0D, (double)var8 * 100.0D / (double)var3));
            return var7;
        }
    }
