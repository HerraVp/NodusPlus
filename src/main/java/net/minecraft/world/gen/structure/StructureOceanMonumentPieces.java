...
public class StructureOceanMonumentPieces
{
    ...
    public static class MonumentBuilding extends Piece
    {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
        {
            ...
            var6.add(new XYDoubleRoomFitHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new YZDoubleRoomFitHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new ZDoubleRoomFitHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new XDoubleRoomFitHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new YDoubleRoomFitHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new FitSimpleRoomTopHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            var6.add(new FitSimpleRoomHelper((StructureOceanMonumentPieces.SwitchEnumFacing)null));
            Iterator var7 = var5.iterator();

            while (var7.hasNext())
            {
                RoomDefinition var8 = (RoomDefinition)var7.next();
                ...
                if (!var8.field_175963_d && !var8.func_175961_b())
                {
                    ...
                    while (var9.hasNext())
                    {
                        MonumentRoomFitHelper var10 = (MonumentRoomFitHelper)var9.next();
        ...
        private List func_175836_a(Random p_175836_1_)
        {
            ...
            RoomDefinition var15;
            RoomDefinition var16;
            RoomDefinition var18;
            var2[field_175831_h].func_175957_a(EnumFacing.UP, var15 = new RoomDefinition(1003));
            var2[field_175832_i].func_175957_a(EnumFacing.SOUTH, var16 = new RoomDefinition(1001));
            var2[field_175829_j].func_175957_a(EnumFacing.SOUTH, var18 = new RoomDefinition(1002));
            ...
            while (var22.hasNext())
            {
                RoomDefinition var23 = (RoomDefinition)var22.next();
                int var25 = 0;
                var11 = 0;
