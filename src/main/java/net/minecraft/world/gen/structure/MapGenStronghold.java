...
public class MapGenStronghold extends MapGenStructure
{
    ...
    protected StructureStart getStructureStart(int p_75049_1_, int p_75049_2_)
    {
        ...
        for (var3 = new Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_); var3.getComponents().isEmpty() || ((StructureStrongholdPieces.Stairs2)var3.getComponents().get(0)).strongholdPortalRoom == null; var3 = new Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_))
        {
            ;
        }
