...
public class IngestServerTester
{
    ...
    public static enum IngestTestState
    {
        ...
        private static final IngestTestState[] $VALUES = new IngestTestState[]{Uninitalized, Starting, ConnectingToServer, TestingServer, DoneTestingServer, Finished, Cancelling, Cancelled, Failed};
    ...
    static final class SwitchStatType
    {
        ...
        static final int[] field_176002_b = new int[IngestTestState.values().length];
        ...
        static
        {
            try
            {
                field_176002_b[IngestTestState.Starting.ordinal()] = 1;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.DoneTestingServer.ordinal()] = 2;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.ConnectingToServer.ordinal()] = 3;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.TestingServer.ordinal()] = 4;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.Cancelling.ordinal()] = 5;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.Uninitalized.ordinal()] = 6;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.Finished.ordinal()] = 7;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.Cancelled.ordinal()] = 8;
            }
            ...
            try
            {
                field_176002_b[IngestTestState.Failed.ordinal()] = 9;
            }
