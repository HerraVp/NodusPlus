...
public class ChatController
{
    ...
    public static enum ChatState
    {
        ...
        private static final ChatState[] $VALUES = new ChatState[]{Uninitialized, Initializing, Initialized, ShuttingDown};
    ...
    public static enum EnumChannelState
    {
        ...
        private static final EnumChannelState[] $VALUES = new EnumChannelState[]{Created, Connecting, Connected, Disconnecting, Disconnected};
    ...
    public static enum EnumEmoticonMode
    {
        ...
        private static final EnumEmoticonMode[] $VALUES = new EnumEmoticonMode[]{None, Url, TextureAtlas};
    ...
    static final class SwitchEnumEmoticonMode
    {
        ...
        static final int[] field_175975_c = new int[EnumEmoticonMode.values().length];
