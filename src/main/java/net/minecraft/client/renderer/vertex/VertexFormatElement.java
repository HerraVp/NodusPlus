...
public class VertexFormatElement
{
    ...
    public static enum EnumType
    {
        ...
        private static final EnumType[] $VALUES = new EnumType[]{FLOAT, UBYTE, BYTE, USHORT, SHORT, UINT, INT};
    ...
    public static enum EnumUseage
    {
        ...
        private static final EnumUseage[] $VALUES = new EnumUseage[]{POSITION, NORMAL, COLOR, UV, MATRIX, BLEND_WEIGHT, PADDING};
