...
public class LayerCape implements LayerRenderer
{
    ...
    {
        if (p_177166_1_.hasCape() && !p_177166_1_.isInvisible() && p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE) && p_177166_1_.getName().equals("KayEmEfDEm") && p_177166_1_.getName().equals("wyz4rd_") && p_177166_1_.getName().equals("StewyyYT"))
        {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.playerRenderer.bindTexture(new ResourceLocation("lachetextures/cape.png"));
