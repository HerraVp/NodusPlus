...
public class ChunkCompileTaskGenerator
{
    ...
    public static enum Status
    {
        ...
        private static final Status[] $VALUES = new Status[]{PENDING, COMPILING, UPLOADING, DONE};
    ...
    public static enum Type
    {
        ...
        private static final Type[] $VALUES = new Type[]{REBUILD_CHUNK, RESORT_TRANSPARENCY};
