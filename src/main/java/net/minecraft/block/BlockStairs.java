...
public class BlockStairs extends Block
{
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        return facing != EnumFacing.DOWN && (facing == EnumFacing.UP || (double)hitY <= 0.5D) ? var9.withProperty(HALF, EnumHalf.BOTTOM) : var9.withProperty(HALF, EnumHalf.TOP);
    }
    ...
    {
        IBlockState var2 = this.getDefaultState().withProperty(HALF, (meta & 4) > 0 ? EnumHalf.TOP : EnumHalf.BOTTOM);
    ...
    public static enum EnumHalf implements IStringSerializable
    {
        ...
        private static final EnumHalf[] $VALUES = new EnumHalf[]{TOP, BOTTOM};
    ...
    public static enum EnumShape implements IStringSerializable
    {
        ...
        private static final EnumShape[] $VALUES = new EnumShape[]{STRAIGHT, INNER_LEFT, INNER_RIGHT, OUTER_LEFT, OUTER_RIGHT};
