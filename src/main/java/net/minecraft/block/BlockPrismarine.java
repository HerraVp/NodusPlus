...
public class BlockPrismarine extends Block
{
    ...
    {
        super(Material.rock);
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANTS, EnumType.ROUGH));
    ...
    {
        return this.getDefaultState().withProperty(VARIANTS, EnumType.func_176810_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176813_d = new EnumType[values().length];
        private final int meta;
        private final String field_176811_f;
        private final String field_176812_g;

        private static final EnumType[] $VALUES = new EnumType[]{ROUGH, BRICKS, DARK};
