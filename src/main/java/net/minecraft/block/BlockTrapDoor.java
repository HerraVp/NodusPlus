...
public class BlockTrapDoor extends Block
{
    ...
    {
        super(p_i45434_1_);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176284_a, EnumFacing.NORTH).withProperty(field_176283_b, Boolean.valueOf(false)).withProperty(field_176285_M, DoorHalf.BOTTOM));
        float var2 = 0.5F;
        float var3 = 1.0F;
    ...
    {
        return this.getDefaultState().withProperty(field_176284_a, func_176281_b(meta)).withProperty(field_176283_b, Boolean.valueOf((meta & 4) != 0)).withProperty(field_176285_M, (meta & 8) == 0 ? DoorHalf.BOTTOM : DoorHalf.TOP);
    }
    ...
    public static enum DoorHalf implements IStringSerializable
    {
        ...
        private static final DoorHalf[] $VALUES = new DoorHalf[]{TOP, BOTTOM};
