...
public class BlockSandStone extends Block
{
    ...
    {
        super(Material.rock);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176297_a, EnumType.DEFAULT));
    ...
    {
        return this.getDefaultState().withProperty(field_176297_a, EnumType.func_176673_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176679_d = new EnumType[values().length];
        private final int field_176680_e;
        private final String field_176677_f;
        private final String field_176678_g;

        private static final EnumType[] $VALUES = new EnumType[]{DEFAULT, CHISELED, SMOOTH};
