...
public class BlockPistonExtension extends Block
{
    ...
    public BlockPistonExtension()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176326_a, EnumFacing.NORTH).withProperty(field_176325_b, EnumPistonType.DEFAULT).withProperty(field_176327_M, Boolean.valueOf(false)));
    ...
    {
        return this.getDefaultState().withProperty(field_176326_a, func_176322_b(meta)).withProperty(field_176325_b, (meta & 8) > 0 ? EnumPistonType.STICKY : EnumPistonType.DEFAULT);
    }
    ...
    public static enum EnumPistonType implements IStringSerializable
    {
        ...
        private static final EnumPistonType[] $VALUES = new EnumPistonType[]{DEFAULT, STICKY};
