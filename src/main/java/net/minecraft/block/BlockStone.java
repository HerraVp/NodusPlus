...
public class BlockStone extends Block
{
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.getStateFromMeta(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] BLOCKSTATES = new EnumType[values().length];
        private final int meta;
        private final String name;
        private final String field_176654_k;

        private static final EnumType[] $VALUES = new EnumType[]{STONE, GRANITE, GRANITE_SMOOTH, DIORITE, DIORITE_SMOOTH, ANDESITE, ANDESITE_SMOOTH};
