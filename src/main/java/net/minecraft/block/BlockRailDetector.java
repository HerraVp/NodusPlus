...
{
    public static final PropertyEnum field_176573_b = PropertyEnum.create("shape", EnumRailDirection.class, new Predicate()
    {
        private static final String __OBFID = "CL_00002126";
        public boolean func_180344_a(EnumRailDirection p_180344_1_)
        {
    ...
    {
        super(true);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176574_M, Boolean.valueOf(false)).withProperty(field_176573_b, EnumRailDirection.NORTH_SOUTH));
    ...
    {
        return this.getDefaultState().withProperty(field_176573_b, EnumRailDirection.func_177016_a(meta & 7)).withProperty(field_176574_M, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    {
        byte var2 = 0;
        int var3 = var2 | ((EnumRailDirection)state.getValue(field_176573_b)).func_177015_a();
