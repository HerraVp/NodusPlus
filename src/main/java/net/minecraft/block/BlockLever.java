...
public class BlockLever extends Block
{
    ...
    {
        if (this.func_176356_e(worldIn, pos) && !this.func_176358_d(worldIn, pos.offset(((EnumOrientation)state.getValue(FACING)).func_176852_c().getOpposite())))
        {
    ...
    {
        return !((Boolean)state.getValue(POWERED)).booleanValue() ? 0 : (((EnumOrientation)state.getValue(FACING)).func_176852_c() == side ? 15 : 0);
    }
    ...
    {
        return this.getDefaultState().withProperty(FACING, EnumOrientation.func_176853_a(meta & 7)).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    public static enum EnumOrientation implements IStringSerializable
    {
        ...
        private static final EnumOrientation[] $VALUES = new EnumOrientation[]{DOWN_X, EAST, WEST, SOUTH, NORTH, UP_Z, UP_X, DOWN_Z};
