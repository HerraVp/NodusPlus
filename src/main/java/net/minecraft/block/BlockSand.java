...
public class BlockSand extends BlockFalling
{
    ...
    public BlockSand()
    {
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, EnumType.SAND));
    }
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.func_176686_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176695_c = new EnumType[values().length];
        ...
        private static final EnumType[] $VALUES = new EnumType[]{SAND, RED_SAND};
