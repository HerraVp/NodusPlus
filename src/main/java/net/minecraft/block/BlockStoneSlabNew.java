...
public abstract class BlockStoneSlabNew extends BlockSlab
{
    ...
    public BlockStoneSlabNew()
    {
        ...
        this.setDefaultState(var1.withProperty(field_176559_M, EnumType.RED_SANDSTONE));
    ...
    {
        IBlockState var2 = this.getDefaultState().withProperty(field_176559_M, EnumType.func_176916_a(meta & 7));
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176921_b = new EnumType[values().length];
        private final int field_176922_c;
        private final String field_176919_d;

        private static final EnumType[] $VALUES = new EnumType[]{RED_SANDSTONE};
