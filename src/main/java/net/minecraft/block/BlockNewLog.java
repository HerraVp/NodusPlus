...
public class BlockNewLog extends BlockLog
{
    ...
    public BlockNewLog()
    {
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176300_b, BlockPlanks.EnumType.ACACIA).withProperty(AXIS_PROP, EnumAxis.Y));
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        {
            case 0:
                var2 = var2.withProperty(AXIS_PROP, EnumAxis.Y);
                break;

            case 4:
                var2 = var2.withProperty(AXIS_PROP, EnumAxis.X);
                break;

            case 8:
                var2 = var2.withProperty(AXIS_PROP, EnumAxis.Z);
                break;

            default:
                var2 = var2.withProperty(AXIS_PROP, EnumAxis.NONE);
        }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        switch (SwitchEnumAxis.field_180191_a[((EnumAxis)state.getValue(AXIS_PROP)).ordinal()])
        {
            case 1:
                var3 |= 4;
                break;
    ...
    {
        static final int[] field_180191_a = new int[EnumAxis.values().length];
        ...
        static
        {
            try
            {
                field_180191_a[EnumAxis.X.ordinal()] = 1;
            }
            ...
            try
            {
                field_180191_a[EnumAxis.Z.ordinal()] = 2;
            }
            ...
            try
            {
                field_180191_a[EnumAxis.NONE.ordinal()] = 3;
            }
