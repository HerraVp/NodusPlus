...
{
    public static final PropertyEnum field_176565_b = PropertyEnum.create("shape", EnumRailDirection.class);
    private static final String __OBFID = "CL_00000293";

    protected BlockRail()
    {
        super(false);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176565_b, EnumRailDirection.NORTH_SOUTH));
    }
    ...
    {
        return this.getDefaultState().withProperty(field_176565_b, EnumRailDirection.func_177016_a(meta));
    }
    ...
    {
        return ((EnumRailDirection)state.getValue(field_176565_b)).func_177015_a();
    }
