...
public class BlockSilverfish extends Block
{
    ...
    {
        super(Material.clay);
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, EnumType.STONE));
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.func_176879_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176885_g = new EnumType[values().length];
        private final int field_176893_h;
        private final String field_176894_i;
        private final String field_176891_j;

        private static final EnumType[] $VALUES = new EnumType[]{STONE, COBBLESTONE, STONEBRICK, MOSSY_STONEBRICK, CRACKED_STONEBRICK, CHISELED_STONEBRICK};
        ...
        EnumType(String p_i45706_1_, int p_i45706_2_, int p_i45706_3_, String p_i45706_4_, SwitchEnumType p_i45706_5_)
        {
            this(p_i45706_1_, p_i45706_2_, p_i45706_3_, p_i45706_4_);
        }

        EnumType(String p_i45707_1_, int p_i45707_2_, int p_i45707_3_, String p_i45707_4_, String p_i45707_5_, SwitchEnumType p_i45707_6_)
        {
