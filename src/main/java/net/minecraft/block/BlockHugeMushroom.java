...
public class BlockHugeMushroom extends Block
{
    ...
    {
        super(p_i45711_1_);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176380_a, EnumType.ALL_OUTSIDE));
    ...
    {
        return this.getDefaultState().withProperty(field_176380_a, EnumType.func_176895_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] $VALUES = new EnumType[]{NORTH_WEST, NORTH, NORTH_EAST, WEST, CENTER, EAST, SOUTH_WEST, SOUTH, SOUTH_EAST, STEM, ALL_INSIDE, ALL_OUTSIDE, ALL_STEM};
