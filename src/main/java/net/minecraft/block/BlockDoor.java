...
public class BlockDoor extends Block
{
    ...
    {
        super(p_i45402_1_);
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING_PROP, EnumFacing.NORTH).withProperty(OPEN_PROP, Boolean.valueOf(false)).withProperty(HINGEPOSITION_PROP, EnumHingePosition.LEFT).withProperty(POWERED_PROP, Boolean.valueOf(false)).withProperty(HALF_PROP, EnumDoorHalf.LOWER));
    }
    ...
    public static enum EnumDoorHalf implements IStringSerializable
    {
        ...
        private static final EnumDoorHalf[] $VALUES = new EnumDoorHalf[]{UPPER, LOWER};
    ...
    public static enum EnumHingePosition implements IStringSerializable
    {
        ...
        private static final EnumHingePosition[] $VALUES = new EnumHingePosition[]{LEFT, RIGHT};
