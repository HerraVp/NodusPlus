...
public class BlockPlanks extends Block
{
    ...
    {
        super(Material.wood);
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, EnumType.OAK));
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.func_176837_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176842_g = new EnumType[values().length];
        private final int field_176850_h;
        private final String field_176851_i;
        private final String field_176848_j;

        private static final EnumType[] $VALUES = new EnumType[]{OAK, SPRUCE, BIRCH, JUNGLE, ACACIA, DARK_OAK};
