...
public class BlockTallGrass extends BlockBush implements IGrowable
{
    ...
    {
        super(Material.vine);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176497_a, EnumType.DEAD_BUSH));
        float var1 = 0.4F;
    ...
    {
        return this.getDefaultState().withProperty(field_176497_a, EnumType.func_177045_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] $VALUES = new EnumType[]{DEAD_BUSH, GRASS, FERN};
