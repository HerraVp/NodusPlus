...
public class BlockQuartz extends Block
{
    ...
    {
        super(Material.rock);
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, EnumType.DEFAULT));
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        if (meta == EnumType.LINES_Y.getMetaFromState())
        {
            ...
            {
                case 1:
                    return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.LINES_Z);

                case 2:
                    return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.LINES_X);

                case 3:
                default:
                    return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.LINES_Y);
            }
        }
        else
        {
            return meta == EnumType.CHISELED.getMetaFromState() ? this.getDefaultState().withProperty(VARIANT_PROP, EnumType.CHISELED) : this.getDefaultState().withProperty(VARIANT_PROP, EnumType.DEFAULT);
        }
    }
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, EnumType.func_176794_a(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] $VALUES = new EnumType[]{DEFAULT, CHISELED, LINES_Y, LINES_X, LINES_Z};
