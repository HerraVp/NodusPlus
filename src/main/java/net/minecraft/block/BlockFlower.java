...
public abstract class BlockFlower extends BlockBush
{
    ...
    public static enum EnumFlowerColor
    {
        ...
        private static final EnumFlowerColor[] $VALUES = new EnumFlowerColor[]{YELLOW, RED};
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        private static final EnumFlowerType[][] field_176981_k = new EnumFlowerType[EnumFlowerColor.values().length][];
        ...
        private static final EnumFlowerType[] $VALUES = new EnumFlowerType[]{DANDELION, POPPY, BLUE_ORCHID, ALLIUM, HOUSTONIA, RED_TULIP, ORANGE_TULIP, WHITE_TULIP, PINK_TULIP, OXEYE_DAISY};
        ...
        static {
            ...
            {
                final EnumFlowerColor var3 = var0[var2];
