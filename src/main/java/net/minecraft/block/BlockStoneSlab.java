...
public abstract class BlockStoneSlab extends BlockSlab
{
    ...
    public BlockStoneSlab()
    {
        ...
        {
            var1 = var1.withProperty(HALF_PROP, EnumBlockHalf.BOTTOM);
        }

        this.setDefaultState(var1.withProperty(field_176556_M, EnumType.STONE));
    ...
    {
        IBlockState var2 = this.getDefaultState().withProperty(field_176556_M, EnumType.func_176625_a(meta & 7));
        ...
        {
            var2 = var2.withProperty(HALF_PROP, (meta & 8) == 0 ? EnumBlockHalf.BOTTOM : EnumBlockHalf.TOP);
        }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        else if (state.getValue(HALF_PROP) == EnumBlockHalf.TOP)
        {
            var3 |= 8;
        }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EnumType[] field_176640_i = new EnumType[values().length];
        private final int field_176637_j;
        private final String field_176638_k;
        private final String field_176635_l;

        private static final EnumType[] $VALUES = new EnumType[]{STONE, SAND, WOOD, COBBLESTONE, BRICK, SMOOTHBRICK, NETHERBRICK, QUARTZ};
