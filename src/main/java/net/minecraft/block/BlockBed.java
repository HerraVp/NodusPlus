...
public class BlockBed extends BlockDirectional
{
    ...
    public BlockBed()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(PART_PROP, EnumPartType.FOOT).withProperty(OCCUPIED_PROP, Boolean.valueOf(false)));
        this.setBedBounds();
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return (meta & 8) > 0 ? this.getDefaultState().withProperty(PART_PROP, EnumPartType.HEAD).withProperty(AGE, var2).withProperty(OCCUPIED_PROP, Boolean.valueOf((meta & 4) > 0)) : this.getDefaultState().withProperty(PART_PROP, EnumPartType.FOOT).withProperty(AGE, var2);
    }
    ...
    public static enum EnumPartType implements IStringSerializable
    {
        ...
        private static final EnumPartType[] $VALUES = new EnumPartType[]{HEAD, FOOT};
