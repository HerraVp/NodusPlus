...
{
    public static final PropertyEnum field_176568_b = PropertyEnum.create("shape", EnumRailDirection.class, new Predicate()
    {
        private static final String __OBFID = "CL_00002080";
        public boolean func_180133_a(EnumRailDirection p_180133_1_)
        {
    ...
    {
        super(true);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176568_b, EnumRailDirection.NORTH_SOUTH).withProperty(field_176569_M, Boolean.valueOf(false)));
    }
    ...
    protected boolean func_176566_a(World worldIn, BlockPos p_176566_2_, IBlockState p_176566_3_, boolean p_176566_4_, int p_176566_5_)
    {
        ...
        else
        {
            ...
            boolean var9 = true;
            EnumRailDirection var10 = (EnumRailDirection)p_176566_3_.getValue(field_176568_b);
    ...
    protected boolean func_176567_a(World worldIn, BlockPos p_176567_2_, boolean p_176567_3_, int p_176567_4_, EnumRailDirection p_176567_5_)
    {
        ...
        {
            EnumRailDirection var7 = (EnumRailDirection)var6.getValue(field_176568_b);
            return p_176567_5_ == EnumRailDirection.EAST_WEST && (var7 == EnumRailDirection.NORTH_SOUTH || var7 == EnumRailDirection.ASCENDING_NORTH || var7 == EnumRailDirection.ASCENDING_SOUTH) ? false : (p_176567_5_ == EnumRailDirection.NORTH_SOUTH && (var7 == EnumRailDirection.EAST_WEST || var7 == EnumRailDirection.ASCENDING_EAST || var7 == EnumRailDirection.ASCENDING_WEST) ? false : (((Boolean)var6.getValue(field_176569_M)).booleanValue() ? (worldIn.isBlockPowered(p_176567_2_) ? true : this.func_176566_a(worldIn, p_176567_2_, var6, p_176567_3_, p_176567_4_ + 1)) : false));
        }
    }
    ...
    protected void func_176561_b(World worldIn, BlockPos p_176561_2_, IBlockState p_176561_3_, Block p_176561_4_)
    {
        ...
        if (var6 != var5)
        {
            ...
            if (((EnumRailDirection)p_176561_3_.getValue(field_176568_b)).func_177018_c())
            {
    ...
    {
        return this.getDefaultState().withProperty(field_176568_b, EnumRailDirection.func_177016_a(meta & 7)).withProperty(field_176569_M, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    {
        byte var2 = 0;
        int var3 = var2 | ((EnumRailDirection)state.getValue(field_176568_b)).func_177015_a();
    ...
    {
        static final int[] field_180121_a = new int[EnumRailDirection.values().length];
        ...
        static
        {
            try
            {
                field_180121_a[EnumRailDirection.NORTH_SOUTH.ordinal()] = 1;
            }
            ...
            try
            {
                field_180121_a[EnumRailDirection.EAST_WEST.ordinal()] = 2;
            }
            ...
            try
            {
                field_180121_a[EnumRailDirection.ASCENDING_EAST.ordinal()] = 3;
            }
            ...
            try
            {
                field_180121_a[EnumRailDirection.ASCENDING_WEST.ordinal()] = 4;
            }
            ...
            try
            {
                field_180121_a[EnumRailDirection.ASCENDING_NORTH.ordinal()] = 5;
            }
            ...
            try
            {
                field_180121_a[EnumRailDirection.ASCENDING_SOUTH.ordinal()] = 6;
            }
