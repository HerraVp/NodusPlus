...
public class BlockFlowerPot extends BlockContainer
{
    ...
    public BlockFlowerPot()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176443_b, EnumFlowerType.EMPTY).withProperty(field_176444_a, Integer.valueOf(0)));
