...
public class BlockOldLog extends BlockLog
{
    ...
    public BlockOldLog()
    {
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, BlockPlanks.EnumType.OAK).withProperty(AXIS_PROP, EnumAxis.Y));
    }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        switch (SwitchEnumAxis.field_180203_a[((EnumAxis)state.getValue(AXIS_PROP)).ordinal()])
        {
            case 1:
                var3 |= 4;
                break;
    ...
    {
        static final int[] field_180203_a = new int[EnumAxis.values().length];
        ...
        static
        {
            try
            {
                field_180203_a[EnumAxis.X.ordinal()] = 1;
            }
            ...
            try
            {
                field_180203_a[EnumAxis.Z.ordinal()] = 2;
            }
            ...
            try
            {
                field_180203_a[EnumAxis.NONE.ordinal()] = 3;
            }
