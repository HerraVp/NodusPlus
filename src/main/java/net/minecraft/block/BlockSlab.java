...
public abstract class BlockSlab extends Block
{
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        return this.isDouble() ? var9 : (facing != EnumFacing.DOWN && (facing == EnumFacing.UP || (double)hitY <= 0.5D) ? var9 : var9.withProperty(HALF_PROP, EnumBlockHalf.TOP));
    }
    ...
    public static enum EnumBlockHalf implements IStringSerializable
    {
        ...
        private static final EnumBlockHalf[] $VALUES = new EnumBlockHalf[]{TOP, BOTTOM};
